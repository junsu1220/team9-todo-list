...
export const __todosThunk = createAsyncThunk("getTodos", async(payload, thunkAPI)=>{
 try{
...
export const editComment = createAsyncThunk("updateTodos", async({id, username, comment})=>{
  const data = await axios.put(`http://localhost:3001/comments/${id}`,{username, comment});
